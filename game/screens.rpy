...
init -1 style frame:
    ...
    background Frame("mod_assets/modframe.png", gui.frame_borders, tile=gui.frame_tile)
...
init -1 style window:
    ...
    background Image("mod_assets/modtextbox.png", xalign=0.5, yalign=1.0)
...
init -1 style namebox:
    ...
    background Frame("mod_assets/modnamebox.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
...
init -1 python:
    def FileActionMod(name, page=None, **kwargs):
        ...
        #    return Show(screen="dialog", message="Error: this save is from a previous phase of \"Doki Doki CloudBreaker\".",
...
init -1 style confirm_frame:
    background Frame([ "gui/confirm_frame.png", "mod_assets/modframe.png"], gui.confirm_frame_borders, tile=gui.frame_tile)
