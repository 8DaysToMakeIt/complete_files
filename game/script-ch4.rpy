label DEADLINKmodintro:
    ...
    pause 2.0
    call screen dialog("...fine. I'll play your little game.", ok_action=Return())
    call screen dialog("Don't think I'll like it though.", ok_action=Return()) 
    $ consolehistory = []
